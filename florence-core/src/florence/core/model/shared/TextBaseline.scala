...
/** Represents the baseline indicating the reference position that is used when rendering text within a chart.
  ...
  *
  * The definition of this type is based on the following specification: https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/textBaseline
  */
